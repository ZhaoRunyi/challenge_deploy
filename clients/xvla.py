...
def build_full_piper_state(
    ...
    *,
    state_gripper_encoding: StateGripperEncoding = "meters",
) -> np.ndarray:
    return build_slai_full_piper_state(snapshot, spec, state_gripper_encoding=state_gripper_encoding)
...
class XVLAPiperClient(SlaiPiperClient):
    def __init__(
        self,
        ...
        *,
        ...
        state_gripper_encoding: StateGripperEncoding = "meters",
        action_gripper_encoding: ActionGripperEncoding = "binary",
    ) -> None:
